...
class ScrollmapWithZoom {
    ...
    protected _optionsChanged = {
        bWheelZooming: < boolean > undefined,
        wheelZooming: < number > undefined,
        pinchZooming: < boolean > undefined,
        btnsDivOnMap: < boolean > undefined,
        btnsDivPositionOutsideMap: < string > undefined,
    };
    ...
    create(container_div: HTMLElement, scrollable_div: HTMLElement, surface_div: HTMLElement, onsurface_div: HTMLElement, clipped_div: HTMLElement = null, animation_div: HTMLElement = null, page: object = null, create_extra: Function = null) {
        ...
        this._createForm();
        this.btnIncreaseHeightHtml ??= `<a class="enlargedisplay enlarge_or_reduce_as_text">↓  ${__("lang_mainsite", "Enlarge")}  ↓</a>`;
    ...
    protected _setButtonsVisiblity(visible: boolean) {
